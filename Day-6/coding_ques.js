...
// const filtered_flights = arr.filter((flight) => flight.price >= 100 && flight.price <= 500);
...
//     console.log(`Promotion applied! ${discountedItems} items were discounted for a total saving of ${totalSavings}.`);
...
// const final_res = JSON.stringify(movies);
// console.log(final_res);
