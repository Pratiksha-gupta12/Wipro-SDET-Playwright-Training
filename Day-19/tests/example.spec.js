...
// //goto -> page[ads,popups, promotion banner, forms popup] --> close them --> executing test cases
...
//     await exepect (preparedPage.getByRole('heading', { name: 'Installation'})).toBeVisible()
//   });
// })
